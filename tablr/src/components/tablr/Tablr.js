...
export const Tablr = ({
  ...
  useEffect(() => {
    ...
    } else if (!rows || !rows.every((r) => r.length === headers.length)) {
      throw Error("Row length must equal header length");
    }
  }, [rows, headers]);

  const cellPaddingObj = {
    small: "3px",
    medium: "8px",
    large: "15px",
  };
        ...
        <div key={columnIndex} className={styles.column}>
          <div
            ...
            style={{
              ...
              padding: cellPaddingObj[cellPadding],
              backgroundColor: headerBackgroundColor,
              border: `${borderWidthObj[borderWidth]} solid ${headerBorderColor}`,
            }}
          >
            {h}
          </div>
            ...
            {rows.map((r, rowIndex) => (
              <div
                ...
                style={{
                  ...
                  padding: cellPaddingObj[cellPadding],
                  border: `${borderWidthObj[borderWidth]} solid ${cellBorderColor}`,
                }}
              >
                {r[columnIndex]}
              </div>
